...
``color3.json``
    Same as ``color.json``, but for level 3 tests incompatible with level 4.

``color4.json``
    Same as ``color.json``, but for level 4 tests incompatible with level 3.

``color_keywords.json``
    Same as ``color.json``,
    except that the values for the Red, Green and Blue channel
    are between 0 and 255.
    This file is generated by the ``make_color_keywords.py`` Python script.

``color3_keywords.json``
    Same as ``color_keywords.json``, but for level 3 tests incompatible with
    level 4.

``color4_keywords.json``
    Same as ``color_keywords.json``, but for level 4 tests incompatible with
    level 3.

``color_hsl.json``
    Same as ``color.json``.
    This file is generated by the ``make_color_hsl.py`` Python script.
